...
console.log('const shares = [' + abdk64x64Shares.join('n,') + 'n]');
console.log('const addresses = ["' + addresses.join('","') + '"]');
console.log('let router = await DoubleSupplyStakingRouter.at("0xd35181CDCE436439b6562380844C7572A991FE16")');
console.log('await router.changeStakingServiceShares(addresses, shares)')
