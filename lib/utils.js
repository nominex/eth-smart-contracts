...
module.exports = {
    ...
    scheduleItem: ({
      ...
      reserveFundPoolRate,
      premineBonusPoolRate}) => {
        return {
          repeatCount: repeatCount,
          blockCount: blockCount,
          rewardRate: "0x" + toWei(toBN(rewardRate)).divn(24 * 60 * 60).toString(16),
          repeatMultiplier: to64x64(repeatMultiplier),
          bonusPoolRate: to64x64(bonusPoolRate),
          affiliateTeamStakingPoolRate: to64x64(affiliateTeamStakingPoolRate),
          fundingTeamPoolRate: to64x64(fundingTeamPoolRate),
          operationalFundPoolRate: to64x64(operationalFundPoolRate),
          reserveFundPoolRate: to64x64(reserveFundPoolRate),
          premineBonusPoolRate: to64x64(premineBonusPoolRate)
        }
    }
};